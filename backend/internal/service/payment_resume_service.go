...
func NormalizeVisibleMethodSource(method, source string) string {
	...
	case payment.TypeAlipay:
		...
		case VisibleMethodSourceFastPayAlipay, payment.TypeFastPay:
			return VisibleMethodSourceFastPayAlipay
		}
	case payment.TypeWxpay:
		...
		case VisibleMethodSourceFastPayWechat, payment.TypeFastPay:
			return VisibleMethodSourceFastPayWechat
		}
	}
	return ""
}
...
func VisibleMethodProviderKeyForSource(method, source string) (string, bool) {
	...
	case VisibleMethodSourceFastPayAlipay:
		return payment.TypeFastPay, NormalizeVisibleMethod(method) == payment.TypeAlipay
	...
	case VisibleMethodSourceFastPayWechat:
		return payment.TypeFastPay, NormalizeVisibleMethod(method) == payment.TypeWxpay
	default:
		return "", false
	}
}
