...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeFastPay:   {"apisecret": {}, "merchantno": {}, "shopno": {}},
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeFastPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true,
}
