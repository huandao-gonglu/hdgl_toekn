export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_merchantNo: 'Merchant No',
        field_apiSecret: 'API Secret',
        field_shopNo: 'Shop No',
        field_payPageBase: 'Payment Page Base URL',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to AI Gateway',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the AI Gateway AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
