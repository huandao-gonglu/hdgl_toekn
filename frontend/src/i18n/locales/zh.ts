  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        skipAutoResponsesPath: '禁止自动追加 /responses 路径',
        skipAutoResponsesPathHint: '启用后，base URL 将原样使用（如 /v1/chat/completions），不会自动追加 /v1/responses 后缀',
    ...
    settings: {
      ...
      payment: {
        ...
        field_apiSecret: 'API 密钥',
        field_shopNo: '店铺号',
        field_payPageBase: '支付页基础地址',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 AI Gateway',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 AI Gateway AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
